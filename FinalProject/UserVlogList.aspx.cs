...
{
    public partial class UserVlogList : System.Web.UI.Page
    {
        ...
        void getVlogByID()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from vlog_upload WHERE vlog_id ='" + TextBox1.Text.Trim() + "' And User_id="+Session["User_id"], con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
                if (dt.Rows.Count >= 1)
        ...
        bool checkIfVlogExists()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from vlog_upload where vlog_id ='" + TextBox1.Text.Trim() + "' OR vlog_name='" + TextBox2.Text.Trim() + "' and user_id="+ Session["User_id"], con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
